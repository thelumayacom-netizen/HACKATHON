        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2">
              <span style={{color: '#00ffff'}}>AI Investment Hub</span>
            </h1>
            <p className="text-muted-foreground">Your personal AI-powered investment assistant</p>
          </div>
          <div className="flex items-center space-x-3 p-2 rounded-xl">
            <Brain className="w-5 h-5 animate-pulse" style={{color: '#00ffff'}} />
            <span className="font-semibold" style={{color: '#00ffff'}}>Gemini Powered</span>
          </div>
        </div>

        <Tabs defaultValue="trading" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="trading" className="font-semibold">
              <TrendingUp className="w-4 h-4 mr-2" />
              AI Trading Assistant
            </TabsTrigger>
            <TabsTrigger value="investment" className="font-semibold">
              <Target className="w-4 h-4 mr-2" />
              Investment Manager
            </TabsTrigger>
          </TabsList>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-3 text-2xl">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{backgroundColor: '#00ffff20'}}>
                    <TrendingUp className="w-7 h-7" style={{color: '#00ffff'}} />
                  </div>
              ...
              <CardContent className="space-y-6">
                <div className="p-6 rounded-2xl border border-gray-800">
                  <div className="flex items-center space-x-3 mb-4">
                    <Lightbulb className="w-6 h-6 animate-pulse" style={{color: '#00ffff'}} />
                    <span className="font-bold" style={{color: '#00ffff'}}>Ask Your Trading Question</span>
                  </div>
                  <div className="space-y-4">
                    <Textarea
                      placeholder="Ask me anything about trading, market analysis, stock picks, crypto strategies, or technical analysis..."
                ...
                {tradingResponse && (
                  <div className="p-6 rounded-2xl border border-gray-800">
                    <div className="flex items-center space-x-3 mb-4">
                      <Brain className="w-6 h-6 animate-pulse" style={{color: '#00ffff'}} />
                      <span className="font-bold" style={{color: '#00ffff'}}>AI Trading Advice</span>
                    </div>
                    <div className="prose prose-invert max-w-none">
                    ...
                    <div className="flex items-center space-x-2 text-sm px-3 py-2 rounded-full mt-4 bg-gray-800">
                      <CheckCircle className="w-4 h-4" style={{color: '#00ffff'}} />
                      <span className="text-muted-foreground">Powered by Gemini AI • Always do your own research</span>
                    </div>
                  </div>
                )}
          ...
          <TabsContent value="investment" className="space-y-8">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-3 text-2xl">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{backgroundColor: '#00ffff20'}}>
                    <DollarSign className="w-7 h-7" style={{color: '#00ffff'}} />
                  </div>
              ...
              <CardContent className="space-y-6">
                <div className="p-6 rounded-2xl border border-gray-800">
                  <div className="flex items-center space-x-3 mb-4">
                    <MessageSquare className="w-6 h-6 animate-pulse" style={{color: '#00ffff'}} />
                    <span className="font-bold" style={{color: '#00ffff'}}>Plan Your Investment Journey</span>
                  </div>
                  <div className="space-y-4">
                    <Textarea
                      placeholder="Ask me about SIPs, mutual funds, portfolio diversification, retirement planning, or any investment strategy..."
                ...
                {investmentResponse && (
                  <div className="p-6 rounded-2xl border border-gray-800">
                    <div className="flex items-center space-x-3 mb-4">
                      <Brain className="w-6 h-6 animate-pulse" style={{color: '#00ffff'}} />
                      <span className="font-bold" style={{color: '#00ffff'}}>AI Investment Strategy</span>
                    </div>
                    <div className="prose prose-invert max-w-none">
                      <p className="text-foreground leading-relaxed whitespace-pre-wrap">
                        {investmentResponse}
                    ...
                    <div className="flex items-center space-x-2 text-sm px-3 py-2 rounded-full mt-4 bg-gray-800">
                      <CheckCircle className="w-4 h-4" style={{color: '#00ffff'}} />
                      <span className="text-muted-foreground">Powered by Gemini AI • Personalized for your goals</span>
                    </div>
                  </div>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-2xl border border-gray-800">
                <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{backgroundColor: '#00ffff20'}}>
                  <BarChart3 className="w-8 h-8" style={{color: '#00ffff'}} />
                </div>
              ...
              <div className="text-center p-6 rounded-2xl border border-gray-800">
                <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{backgroundColor: '#00ffff20'}}>
                  <Target className="w-8 h-8" style={{color: '#00ffff'}} />
                </div>
              ...
              <div className="text-center p-6 rounded-2xl border border-gray-800">
                ...
                <h3 className="font-bold text-lg mb-2">Instant Responses</h3>
                <p className="text-muted-foreground text-sm">
                  Get immediate answers to your investment questions 24/7 with AI assistance
                </p>
              </div>
